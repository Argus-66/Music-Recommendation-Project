...
# Playlist ID
playlist_id = '3Gjy8Wa7uoJ1tEoSYIFWlE'
...
release_dates = [track['track']['album']['release_date'] for track in playlist_tracks]
popularity = [track['track']['popularity'] for track in playlist_tracks]
preview_urls = [track['track']['preview_url'] for track in playlist_tracks]
